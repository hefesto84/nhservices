...
<body>
	...
	<table class="table table-striped table-bordered table-hover table-custom">
		<tr>
			<th> Tablet </th>
			<td><input type="text" id="tablet" value="<s:property value="tablet.tablet"/>"></td>
		</tr>
		<tr>
			<th> UUID </th>
			<td><input type="text" id="uuid" value="<s:property value="tablet.identificador"/>"></td>
		</tr>
	</table>
	<div id="boton_actualizar" data-url="<s:url value="%{'/backend/tablets/update?id='+id+''}"/>">Actualizar</div>
