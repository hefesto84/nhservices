...
<body>
	...
	<h1 style="text-transform:capitalize;">NEW Sostenibilidad</h1>
	...
	<tr class="table-new-extra">
		...
		<td><textarea cols="60" rows="8" name="form_sostenibilidad" id="form_sostenibilidad" value=""></textarea></td>
	</tr>
	<tr class="table-new-extra">
		<th></th>
	...
	<div class="edit-error-message">! Ya están añadidos los textos de sostenibilidad para este hotel, puedes editarlos</div>
	
	<script type="text/javascript">
	
	var url = "<s:url value='/backend/sostenibilidad/lang'/>";
	...
	$('#button_send').click(function(){
		...
		} else if($('#form_sostenibilidad').val() === ''){
			alert("No has escrito ningún canal");
		} else {
			var url_new = "<s:url value='/backend/sostenibilidad/add'/>";
			$.ajax({
				  method: "POST",
				  url: url_new,
				  data: { 
