...
<body>
	...
	<h1 style="text-transform:capitalize;">NEW Canales</h1>
	...
	<tr class="table-new-extra">
		<th>Lista Canales:</th>
		<td><textarea cols="60" rows="8" name="form_channels" id="form_channels" value=""></textarea></td>
	</tr>
	<tr class="table-new-extra">
		<th></th>
	...
	<div class="edit-error-message">! Ya están añadidos los canales para este hotel, puedes editarlos</div>
	
	<script type="text/javascript">
	
	var url = "<s:url value='/backend/canales/lang'/>";
	...
	$('#button_send').click(function(){
		...
		} else if($('#form_channels').val() === ''){
			alert("No has escrito ningún canal");
		} else {
			var url_new = "<s:url value='/backend/canales/add'/>";
			$.ajax({
				  method: "POST",
				  url: url_new,
				  data: { 
