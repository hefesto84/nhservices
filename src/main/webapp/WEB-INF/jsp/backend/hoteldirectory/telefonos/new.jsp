...
<body>
	...
	<h1 style="text-transform:capitalize;">NEW Telefonos</h1>
	...
	<tr class="table-new-extra">
		<th>Texto Telefonos:</th>
		<td><textarea cols="60" rows="8" name="form_telefonos" id="form_telefonos" value=""></textarea></td>
	</tr>
	<tr class="table-new-extra">
		<th></th>
	...
	<div class="edit-error-message">! Ya están añadidos los textos de telefonos para este hotel, puedes editarlos</div>
	...
	$('#button_send').click(function(){
		...
		} else if($('#form_telefonos').val() === ''){
			alert("No has escrito ningún texto");
		} else {
			var url_new = "<s:url value='/backend/telefonos/add'/>";
			$.ajax({
				  method: "POST",
				  url: url_new,
				  data: { 
